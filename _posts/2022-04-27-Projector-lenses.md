...
![Figure 2](/assets/20220425/2022-04-25-14-25-43.png){: height="600"}
...
如果焦距远大于透镜间隙（ $f_{p}\gg S$ ），透镜为弱透镜（weak lens）。当 $Sk\lt2$ ，$eqn(3)$ 给出，
...
不幸运的是，强透镜的特性对于极片几何形状的细节越来越敏感，使得 $eqn(9)$ 变得非常不可靠。特别地，由于现代物镜的焦距与极片尺寸先比并不大，因此这些镜头不能被视为“薄”透镜。
