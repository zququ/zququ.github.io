...
$$
f\_{\mathrm{Z}}(z) = \int\_{-\infty}^{+\infty}f(x, z-x)\mathrm{d}x
$$
...
& = \int\_{-\infty}^{+\infty}\mathrm{d}x\int\_{-\infty}^{z-x}f(x, y)\mathrm{d}y \\ 
\end{aligned}
$$
...
$$
f\_{\mathrm{Z}}(z) = \int f\_{\mathrm{X}}(x)\cdot f\_{\mathrm{Y}}(z-x)\mathrm{d}x
$$
