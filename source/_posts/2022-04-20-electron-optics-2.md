---
layout: post
title: 电子光学 第二部分 近轴射线方程与常场近似
date: 2022-04-20 10:36:35
comments: true
tags: TEM
---
...
* [1. 近轴射线方程（The paraxial ray equation）](#1-近轴射线方程the-paraxial-ray-equation)
	- [1.1 磁场力](#11-磁场力)
		+ [1.1.1 安培力](#111-安培力)
		+ [1.1.2 洛伦兹力](#112-洛伦兹力)
		+ [1.1.3 磁场力的方向判断](#113-磁场力的方向判断)
	- [1.2 极片（pole-piece）构造](#12-极片pole-piece构造)
	- [1.3 电子在极片中的运动轨迹](#13-电子在极片中的运动轨迹)
* [2. 常场近似（The constant-field approximation）](#2-常场近似the-constant-field-approximation)
...
<img src="/assets/20220419/1.webp" alt="Figure s1" style="width: 500px" />

<p style="text-align: center"><strong>图S1.</strong> 左手平展，让磁感线穿过手心，使大拇指与其余四指垂直，并且都跟手掌在一个平面内。把左手放入磁场中，让磁感线垂直传入手心，手心面向 $N$ 极，四指指向电流所指方向，则大拇指的方向就是导体受力的方向。</p>

### 1.2 极片（pole-piece）构造

轴对称磁场的聚焦作用可以理解如下。图1中为电子透镜的简化图，包括典型的磁通量线。极片（pole-piece）尺寸 $S$，$R_1$，以及 $R_2$ 在图中显示。

<img src="/assets/20220419/2022-04-19-13-32-36.png" alt="Figure 1" style="width: 300px" />

<p style="text-align: center"><strong>图1.</strong> 磁电子透镜的简化图。极片尺寸已经表明，安培定律的路径显示为虚线。磁通量线也被显示为虚线，从而定性地指示了镜头的聚焦作用。远离光轴间隙中的场强标记为 $B_p$。实际使用中，绕组（winding）是水冷的，并且极片是可拆卸的。</p>

透镜极片的重要区域的实际布置见图2。

![Figure 2](/assets/20220419/2022-04-19-13-56-40.png) 

<p style="text-align: center"><strong>图2.</strong> 实际中高分辨率极片的细节。在这种商业设计中，上极片孔径 $2R1$ 为 9 mm，下极片孔径 $2R2$ 为 3 mm，间隙 $S$ 为 5 mm。近轴射线方程</p>
...
![Figure 3](/assets/20220419/pole-piece_1.jpg) 

<p style="text-align: center"><strong>图3.</strong></p>

![Figure 4](/assets/20220419/pole-piece_2.jpg) 
...
![Figure 5](/assets/20220419/cylindrical_coordinate_1.png) 

<p style="text-align: center"><strong>图5.</strong> 一个以 $O$ 为原点、$A$ 为极轴、$L$ 为纵轴的柱坐标系。其中标出的点的径向距离 $\rho=4$ ，角坐标 $\varphi = 130°$，高度 $z=4$。</p>
...
-\arcsin \left(\frac{y}{\rho}\right)+\pi & \text { if } x<0
\end{cases}
$$

![Figure 6](/assets/20220419/Cylindrical_coordinate_surfaces_2.gif) 

<p style="text-align: center"><strong>图6.</strong> 柱坐标面。三个正交分量，$\rho$ （绿色）、$\varphi$ （红色）、$z$ （蓝色），图中每个分量都以恒定速率增加。该点位于三个彩色表面之间的交点处。</p>
